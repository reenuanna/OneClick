...
@csrf
    <input type="text" class="form-control" placeholder="Enter the otp Number" name="otpv" id="otpv">
    <input type="text" class="form-control"  name="otp_mob" id="otp_mob" value="   {{$result->otp_mob}}">
    <input type="submit" class="btn btn-warning btn-lg btn-block" value="verify OTP" id="otpbtn">
    </form>
</div>
</div>
</div>
